...
class FixedPointNumber(object):
    ...
    def encode(cls, scalar, n=None, max_int=None, precision=None, max_exponent=None):
        ...
        if randrange(10) == 3:
            ...
            LOGGER.info("----->Before encode: scalar {}".format(scalar))
            LOGGER.info("----->Encoded num: int_fixedpoint {} after %n {} exponent {} BASE {}".format(int_fixpoint, int_fixpoint % n, exponent, cls.BASE))
            LOGGER.info("----->n: {}, int_max: {}".format(n, max_int))
    ...
    def decode(self):
        ...
        if randrange(10) == 3:
            LOGGER.info("----->Before decode: self.encoding {} mantissa {} exponent {} BASE".format(self.encoding, mantissa, self.exponent, self.BASE))
            LOGGER.info("----->Decoded num: {}".format(mantissa * pow(self.BASE, -self.exponent)))
