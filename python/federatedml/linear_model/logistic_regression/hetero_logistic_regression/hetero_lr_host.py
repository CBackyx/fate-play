...
class HeteroLRHost(HeteroLRBase):
    ...
    def fit_binary(self, data_instances, validate_data):
        ...
        # Two ciphers
        self.host_cipher_operator = self.cipher.paillier_keygen(self.model_param.encrypt_param.key_length)
        self.guest_cipher_operator = self.cipher.gen_paillier_cipher_operator()
        ...
        self.guest_encrypted_calculator = [EncryptModeCalculator(self.guest_cipher_operator,
                                                           self.encrypted_mode_calculator_param.mode,
                                                           self.encrypted_mode_calculator_param.re_encrypted_rate) for _
                                     in range(self.batch_generator.batch_nums)]

        # self.host_encrypted_calculator = [EncryptModeCalculator(self.host_cipher_operator,
        #                                                    self.encrypted_mode_calculator_param.mode,
        #                                                    self.encrypted_mode_calculator_param.re_encrypted_rate) for _
        #                              in range(self.batch_generator.batch_nums)]
        ...
        while self.n_iter_ < self.max_iter:
            ...
            for batch_data in batch_data_generator:
                ...
                optim_host_gradient_host_share, optim_guest_gradient_host_share = self.gradient_loss_operator.compute_gradient_procedure(
                    batch_feat_inst, 
                    self.host_cipher_operator,
